...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('Admin');?>/assets/admin/index2.html"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
...
<script type="text/javascript">
 var path="/Admin/login";
    ...
    { 
      ...
      if(user == "" || password == "")
      {
        $('#errormsg').html('Fill all fields').fadeIn('fast').delay(2000).fadeOut('slow');
        return false;
      }
      else
      {
            ...
            {        
                if(response=='error')
                {
                  $('#errormsg').html('Invalid username or password').fadeIn('fast').delay(2000).fadeOut('slow');
                }
                else
                {
